...
?>
				  <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="award"></i><span class="menu-title text-truncate" data-i18n="Authentication">Admin</span></a>
                    <ul class="menu-content">
                            <ul class="menu-content">
                                <li><a class="d-flex align-items-center" href="app-user-list"><span class="menu-item text-truncate" data-i18n="KullaniciListesi"> Kullanıcı Listesi</span></a>
                                </li>
                                <li><a class="d-flex align-items-center" href="banli-kullanicilar"><span class="menu-item text-truncate" data-i18n="BanliKullanicilar">Banlı Kullanıcılar</span></a>
                                </li>
                            </ul>
						</ul>
						</li>
...
?>
                ...
                <li class=" navigation-header"><span data-i18n="Charts &amp; Maps">Diğer Araçlar</span><i data-feather="more-horizontal"></i>
						...
						<li><a class="d-flex align-items-center" href="../hasta-tani"><i data-feather="heart"></i><span class="menu-item text-truncate" data-i18n="HastaTani">Hasta Tanı</span></a>
                        </li>
