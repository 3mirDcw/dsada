        ...
        <div class="navbar-container d-flex content">
            <div class="bookmark-wrapper d-flex align-items-center">
                ...
                <ul class="nav navbar-nav bookmark-icons">
                    ...
                    <li class="nav-item d-none d-lg-block"><a class="nav-link" href="../discord" target="_blank" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Discord"><i class="ficon" data-feather="chrome"></i></a></li>
